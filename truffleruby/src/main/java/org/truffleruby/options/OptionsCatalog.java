...
public class OptionsCatalog {
    ...
    public static final StringOptionDescription CORE_LOAD_PATH = new StringOptionDescription("core.load_path", "Location to load the Truffle core library from", "truffle:/truffleruby");
